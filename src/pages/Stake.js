                ...
                <Card className="main-card">
                    <div className="stake-header">
                        <h1 className="stake-h1">
                            {" "}
                            {`Kitty Treats`.toUpperCase()}{" "}
                        </h1>
                        <br />
                        <h2 className="stake-h2">
                            {" "}
                            {`Vending Machine`.toUpperCase()}{" "}
                        </h2>
                    </div>
                    <div className="all-cards-div">
                        <Card className="all-staked-card">
                            <div className="all-staked-text">
                                <h3 className="all-staked-h3">
                                    {" "}
                                    {`All Staked FUR`.toUpperCase()}{" "}
                                </h3>
                                <p className="stake-number">
                                    {" "}
                                    {this.displayValue(totalTokenStaked)}{" "}
                                </p>
                            </div>
                        ...
                        <Card className="your-staked-card">
                            <div className="your-staked-text">
                                <h3 className="your-staked-h3">
                                    {" "}
                                    {`Your Staked Fur`.toUpperCase()}{" "}
                                </h3>
                                <p className="stake-number">
                                    {" "}
                                    {this.displayValue(
                        ...
                        <Card className="stake-card">
                            <div className="stake-card-text">
                                ...
                                <p className="stake-number">
                                    {" "}
                                    {this.displayValue(userTokenAmount)}{" "}
                                </p>
